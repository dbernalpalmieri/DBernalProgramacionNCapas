...
namespace BusinessLayer
{
    public class Empresa
    {
        ...
        public static Result GetAll()
        {
            ...
            try
            {
                ...
                using (SqlConnection context = new SqlConnection(Conexion.GetConnection()))
                {
                    ...
                    if (reader.HasRows)
                    {
                        ModelLayer.Empresa empresa = null;
        ...
        public static Result Add(ModelLayer.Empresa empresa)
        {
            Result result = new Result();
            try
            {
                ...
                using (SqlConnection context = new SqlConnection(Conexion.GetConnection()))
                {
                    ...
                    if (execute > 0)
                    {
                        result.Object = new ModelLayer.Empresa
                        {
                            IdEmpresa = idEmpresa
                        };
                        result.Correct = true;
        ...
        public static Result Update(ModelLayer.Empresa empresa)
        {
            Result result = new Result();
            try
            {
        ...
        public static Result GetAllEF(ModelLayer.Empresa empresa)
        {
            Result result = new Result();
            try
            {
                using (DBernalProgramacionNCapasEntities context = new DBernalProgramacionNCapasEntities())
                {
                    ...
                    {
                        result.Objects = new List<object>();
                        ModelLayer.Empresa empresaObj = null;

                        foreach (var item in execute)
                        {
                            empresaObj = new ModelLayer.Empresa();
        ...
        public static Result AddEF(ModelLayer.Empresa empresa)
        {
            Result result = new Result();
            try
            {
        ...
        public static Result UpdateEF(ModelLayer.Empresa empresa)
        {
            Result result = new Result();
            try
            {
        ...
        public static Result AddLinq(ModelLayer.Empresa empresa)
        {
            Result result = new Result();
            try
            {
                using (DBernalProgramacionNCapasEntities context = new DBernalProgramacionNCapasEntities())
                {
                    DataLayer_EF.Empresa empresaEF = new DataLayer_EF.Empresa
                    {
        ...
        public static Result UpdateLinq(ModelLayer.Empresa empresaML)
        {
            Result result = new Result();
            try
            {
                using (DBernalProgramacionNCapasEntities context = new DBernalProgramacionNCapasEntities())
                {
                    DataLayer_EF.Empresa empresaEF = context.Empresas.SingleOrDefault(empresa => empresa.IdEmpresa == empresaML.IdEmpresa);
