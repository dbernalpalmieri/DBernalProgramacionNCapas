    ...
    public class Usuario
    {
        public static void Add()
        {
            ...
            if (usuario != null)
            {
                ...
                Result result = BL.Usuario.AddLinq(usuario);
        ...
        public static void Delete()
        {
            ...
            if (result.Correct && result.Object != null)
            {
                ...
                {
                    // Ejecutamos la operación en la base de datos
                    result = BL.Usuario.DeleteLinq(usuario.IdUsuario);
                    print(result.Message,"");
                    if (result.Correct)
                    {
                        GetAll();
        ...
        {
            // Ejecutamos la operación en la base de datos
            Result result = BL.Usuario.GetAllLinq();
            print(result.Message, "");
        ...
        static void printTable(Result result)
        {
            ...
            ML.Usuario tempUser = null;
            if (result.Objects != null)
            {
                result.Objects.ForEach(obj =>
                {
                    tempUser = (ML.Usuario)obj;
                    table.AddRow(
                        tempUser.IdUsuario,
                        tempUser.Nombre,
            ...
            {
                tempUser = result.Object as ML.Usuario;
                table.AddRow(
                    tempUser.IdUsuario,
                    tempUser.Nombre,
                    tempUser.ApellidoPaterno,
        ...
        static ML.Usuario getData(ML.Usuario usuario)
        {
            bool correct = true;
            try
            {
